...
WrappedAudioDeviceModuleImpl::CreateForTest(
  ...
  audioDevice->ResetAudioDevice(new P2PFileAudioDevice(std::move(fileAudioDeviceDescriptor)));
...
WrappedAudioDeviceModuleImpl::CreateForTest(
  ...
  audioDevice->ResetAudioDevice(new P2PRawAudioDevice(std::move(rawAudioDeviceDescriptor)));
