...
class P2PRawAudioDevice : public webrtc::AudioDeviceGeneric {
public:
  explicit P2PRawAudioDevice(std::shared_ptr<P2PRawAudioDeviceDescriptor>);

  ~P2PRawAudioDevice() override;
...
private:
  ...
  std::shared_ptr<P2PRawAudioDeviceDescriptor> _rawAudioDeviceDescriptor;
};
