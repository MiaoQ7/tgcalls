...
class P2PFileAudioDevice : public webrtc::AudioDeviceGeneric {
public:
  ...
  explicit P2PFileAudioDevice(std::shared_ptr<P2PFileAudioDeviceDescriptor>);

  ~P2PFileAudioDevice() override;
...
private:
  ...
  std::shared_ptr<P2PFileAudioDeviceDescriptor> _fileAudioDeviceDescriptor;
};
